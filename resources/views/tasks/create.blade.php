        ...
        <div class="card-body">
            ...
            <form action="{{ route('tasks.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="judul_task" value="{{ old('judul_task') }}" class="form-control rounded-3" required>
                </div>

                <div class="mb-3">
                    <label class="form-label fw-bold">Deskripsi:</label>
                    <textarea name="deskripsi" class="form-control rounded-3" rows="3" required>{{ old('deskripsi') }}</textarea>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="file" name="lampiran" class="form-control rounded-3" accept="image/*" capture="environment">
                </div>
